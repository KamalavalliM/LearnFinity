...
<body>
	...
	<%
		...
		int score=0;
		if(ans1.equalsIgnoreCase("protected")) ++score;
		if(ans2.equalsIgnoreCase("The subclass method is called")) ++score;
		if(ans3.equalsIgnoreCase("cannot have subclasses")) ++score;
		if(ans4.equalsIgnoreCase("A variable that should not be serialized")) ++score;
		if(ans5.equalsIgnoreCase("IOException")) ++score;
		if(ans6.equalsIgnoreCase("To mark a method as thread-safe")) ++score;
		if(ans7.equalsIgnoreCase("All")) ++score;
		if(ans8.equalsIgnoreCase("final")) ++score;
		if(ans9.equalsIgnoreCase("class")) ++score;
		if(ans10.equalsIgnoreCase("maps")) ++score;
